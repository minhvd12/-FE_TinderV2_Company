      ...
      <Container maxWidth="sm">
        ...
        <Card>
            ...
            <FormControlLabel
              ...
              label={
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <img
                    src="https://firebasestorage.googleapis.com/v0/b/captone-dfc3c.appspot.com/o/images%2FLogo-VNPay.png?alt=media&token=fd61a9dc-f27f-41db-99d9-7d45036289a0"
                    alt="logo"
                    width="50"
                  />
          ...
          <CardActions style={{ justifyContent: 'flex-end' }}>
            <LoadingButton variant="contained" loading={loadingButton} type="submit" onClick={onSubmit}>
              Nạp tiền
            </LoadingButton>
          </CardActions>
        </Card>
